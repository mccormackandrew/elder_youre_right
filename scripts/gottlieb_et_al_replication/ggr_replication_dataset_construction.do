...
cd "/Users/andrewmccormack/Desktop/africa_age_interviewer_effect/data_clean/gottlieb_clean"

*loads program to produce indices (Anderson, 2008)
do "../../scripts/gottlieb_et_al_replication/genindex.do"

*load merged R4 and R5 Afrobarometer data (www.afrobarometer.org)
use "ggross_r4r5append_agediff.dta", clear

*merge in additional variables from R5 & R4
merge 1:1 ROUND RESPNO using "../../data_raw/gottlieb_data/dataverse_files/AddR5Vars.dta", nogen
...
merge m:1 country using "../../data_raw/gottlieb_data/dataverse_files/VulnerabilityNew", gen(_merge2)
drop if _merge2==2
drop _merge2
...
gen cname = Country
drop _merge
merge m:1 cname using "../../data_raw/gottlieb_data/dataverse_files/country_codes.dta", keepus(ccodealp ccodecow ccodewb)
keep if _m==3
drop _merge
...
merge m:1 ccodewb using "../../data_raw/gottlieb_data/dataverse_files/PolOpenness.dta"
...
* Merge CIRI data
**************************************
merge m:m ccodecow ROUND using "../../data_raw/gottlieb_data/dataverse_files/CIRI-ROUND.dta"
drop if _m==2
drop _m
...
saveold "GGR_FinalData_agediff.dta", replace 
